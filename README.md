...
| **rill-server** | 0.3.0 | ✅ **OSC-сервер** (UDP, encode/decode, диспетчеризация) |
...
graph TD
    ...
    %% Планируемые
    SERVER[rill-server<br/>(планируется)]
    CORE -.-> SERVER
...
- 🌐 **rill-server** — OSC-сервер для удалённого управления (в разработке)
