...
kama-graph             # аудиограф (временно отключен)
kama-patchbay          # автоматизация параметров (временно отключен)
kama-oscillators       # осцилляторы (аудио и LFO) (временно отключен)
kama-digital-filters   # цифровые фильтры (временно отключен)
kama-digital-effects   # цифровые эффекты (временно отключен)
