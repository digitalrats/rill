...
/// - 31-band (1/3 octave)
pub struct GraphicEq<F: Filter, Factory: FilterFactory<F>> {
    /// Filter factory
    factory: Factory,
    /// EQ bands
    bands: Vec<EqBand<F>>,
...
impl<F: Filter, Factory: FilterFactory<F>> GraphicEq<F, Factory> {
...
impl<F: Filter, Factory: FilterFactory<F>> AudioNode for GraphicEq<F, Factory> {
    ...
    fn metadata(&self) -> NodeMetadata {
        ...
        NodeMetadata {
            ...
            description: format!("Graphic equalizer using {} filters", self.factory.factory_name()),
