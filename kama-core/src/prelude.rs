...
//! ## Example
//!
// В kama-core/src/lib.rs - строка 151 (пример prelude)
...
// ============================================================================
// Queue Types (from kama-patchbay integration)
// ============================================================================
...
/// Common third-party types that are frequently used with Kama Audio
pub mod external {
