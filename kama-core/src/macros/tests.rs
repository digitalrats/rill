...
sink_node! {
    ...
    fn test_source_node() {
        ...
        node.set_parameter(&param_id, ParamValue::Float(880.0)).unwrap();
    ...
    fn test_processor_node() {
        ...
        node.set_parameter(&param_id, ParamValue::Float(2.0)).unwrap();
    ...
    fn test_sink_node() {
        ...
        node.set_parameter(&param_id, ParamValue::Float(0.5)).unwrap();
