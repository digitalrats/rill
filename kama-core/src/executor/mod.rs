...
//! A real implementation would integrate with a concrete graph (e.g., `kama_graph::AudioGraph`).
//!
//! # Example
//! ```
//! use kama_core::executor::GraphExecutor;
...
pub struct GraphExecutor<T: AudioNum, const BUF_SIZE: usize> {
    ...
    // In reality, this would be something like `graph: kama_graph::AudioGraph<T, BUF_SIZE>`.
