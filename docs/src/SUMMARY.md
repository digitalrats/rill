...
- [rill-core](architecture/core.md)
- [Signal graph (rill-graph)](architecture/graph.md)
- [Actor model (rill-core-actor)](architecture/actor.md)
- [Patchbay Rack](architecture/patchbay-rack.md)
- [MIDI support](architecture/midi.md)
...
- [rill-lang: the Signal DSL](guides/rill-lang-language.md)
