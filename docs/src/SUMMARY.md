...
[About rill-adrift](src/index.md)
[Manifesto](src/manifest.md)
...
- [Git Flow & Contribution Workflow](src/guides/git-flow.md)

# Reference

- [Crates](src/reference/crates.md)
- [Changelog](src/reference/changelog.md)
