# Архитектура Rill (версия 0.4.0)

## Общая концепция

Rill — это **модульная экосистема**, построенная вокруг минимального ядра с трейтами. Каждый крейт имеет чёткую ответственность и может использоваться независимо. После масштабного рефакторинга 0.4.0 все крейты используют единое ядро `rill-core`.
...
### `rill-oscillators` (0.4.0, ✅ активен)
...
### `rill-digital-filters` (0.4.0, ✅ активен)
...
### `rill-digital-effects` (0.4.0, ✅ активен)
...
### `rill-analog-filters` (0.4.0, ✅ активен)
...
### `rill-analog-effects` (0.4.0, ✅ активен)
