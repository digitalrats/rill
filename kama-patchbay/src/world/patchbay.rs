...
use kama_core::queues::{Command, MicroControlObserver, TelemetryQueue};
...
pub struct Patchbay {
    ...
    telemetry_rx: crossbeam_channel::Receiver<kama_core::queues::Telemetry>,
...
impl Patchbay {
    ...
    pub fn add_wild_servo<A: Automaton + 'static>(
        ...
        impl<A: Automaton> crate::servo::WildServoHandle for Wrapper<A> {
            fn update(&mut self, time: WorldTime, graph: &mut kama_graph::AudioGraph) {
